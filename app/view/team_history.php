...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4">
  <div class="container-fluid">
    <a class="navbar-brand">MIS Support Team History Hub</a>
...
<!--
    All tickets ever created from users that are assigned to the manger logged in viewing the dashboard
...
<div class="card shadow-sm">
  ...
  <div class="card-header bg-white">
    <div class="d-flex justify-content-between align-items-center">
      <h5 class="mb-0">Team Support History</h5>
      ...
      <div class="d-flex align-items-center gap-2">
        ...
        <button class="btn btn-sm btn-outline-secondary" id="toggleButton">
          Toggle
        </button>
      </div>
    </div>
          ...
          <tbody>
            <?php foreach ($getAllTasks as $task): ?>
              ...
              >
                ...
                <td><?= htmlspecialchars($task['opened_by']) ?></td>
...
<div class="modal fade" id="viewTaskModal" tabindex="-1" aria-labelledby="viewTaskModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form action="solution/add" method="POST" enctype="multipart/form-data">
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    taskRows.forEach(row => {
      row.addEventListener('click', () => {        
        ...
        /* get the images using data attributes and set the path with the image name */
